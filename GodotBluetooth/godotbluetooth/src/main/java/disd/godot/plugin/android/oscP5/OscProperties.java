...
import disd.godot.plugin.android.netP5.NetAddress;
...
public class OscProperties {
	...
	private int _myDatagramSize = 1024; /* default datagram buffer size */
...
//oscP5.OscP5.LOGGER.warning( "OscProperties.setNetworkProtocol, network protocol can only be set before initializing oscP5." );
		}
		return this;
	}
