...
public class OscMessage extends OscPacket {
	...
	public OscMessage add( final int theValue ) {
		...
		_myArguments[ _myArguments.length - 1 ] = Integer.valueOf( theValue );
		return this;
	}
	...
	public OscMessage add( final float theValue ) {
		...
		_myArguments = increase( 1 );
		_myArguments[ _myArguments.length - 1 ] = Float.valueOf( theValue );
		return this;
	}
	...
	public OscMessage add( final double theValue ) {
		...
		_myArguments = increase( 1 );
		_myArguments[ _myArguments.length - 1 ] = Double.valueOf( theValue );
		return this;
	}
	...
	public OscMessage add( final char theValue ) {
		...
		_myData = Bytes.append( _myData , Bytes.toBytes( theValue ) );
		_myArguments = increase( 1 );
		_myArguments[ _myArguments.length - 1 ] = Character.valueOf( theValue );
		return this;
	}
